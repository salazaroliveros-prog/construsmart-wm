 ...
 * Script para validar la suite completa
 * Uso: node scripts/e2e-test.js <email> <password>
 */
...
// Obtener credenciales de argumentos de línea de comandos
const email = process.argv[2];
const password = process.argv[3];

if (!email || !password) {
  console.log('❌ Error: Se requieren credenciales');
  console.log('Uso: node scripts/e2e-test.js <email> <password>');
  process.exit(1);
}

runE2ETests(email, password).catch(error => {
